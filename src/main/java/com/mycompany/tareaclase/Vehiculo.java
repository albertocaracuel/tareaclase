...
public class Vehiculo implements Comparable<Vehiculo> {
    ...
    public Vehiculo(String marca, String modelo, String color, double precio, boolean disponible) {
    ...
    private String crearMatricula() {
        ...
        int enteroAleatorio = n.nextInt(9999 - 1000 + 1) + 1000;
        String numCadena = String.valueOf(enteroAleatorio);

        String cadena = "";
        for (int i = 0; i < 3; i++) {
            char letraMayus = (char) (n.nextInt(26) + 'A');
            cadena += letraMayus;
        }

        String matricula = numCadena + cadena;
